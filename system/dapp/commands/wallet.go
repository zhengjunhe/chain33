...
func lock(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "DplatformOS.Lock", nil, &res)
	ctx.Run()
}
...
func unLock(cmd *cobra.Command, args []string) {
	...
	var res rpctypes.Reply
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "DplatformOS.UnLock", params, &res)
	ctx.Run()
}
...
func walletStatus(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "DplatformOS.GetWalletStatus", nil, &res)
	ctx.Run()
}
...
func setPwd(cmd *cobra.Command, args []string) {
	...
	var res rpctypes.Reply
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "DplatformOS.SetPasswd", params, &res)
	ctx.Run()
}
...
func walletListTxs(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "DplatformOS.WalletTxList", params, &res)
...
func mergeBalance(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "DplatformOS.MergeBalance", params, &res)
	ctx.Run()
}
...
func noBalanceTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "DplatformOS.CreateNoBalanceTransaction", params, nil)
...
func signRawTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "DplatformOS.SignRawTx", params, nil)
	ctx.RunWithoutMarshal()
}
...
func setFee(cmd *cobra.Command, args []string) {
	...
	var res rpctypes.Reply
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "DplatformOS.SetTxFee", params, &res)
	ctx.Run()
}
