...
const (
	...
	peerInfoReq = "/dplatformos/peerinfoReq/1.0.0" //老版本
	//peerInfoReqV2  = "/dplatformos/peerinfoReq/1.0.1" //新版本，增加dplatformos version 信息反馈
	peerVersionReq = "/dplatformos/peerVersion/1.0.0"
